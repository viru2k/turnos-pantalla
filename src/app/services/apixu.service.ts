...
// SE AGREGO LA RUTA CORS ANYWHERE HEROKU
  getWeather(){
    ...
    //return this.http.get<any[]>('http://api.openweathermap.org/data/2.5/weather?q=San%20juan,%20argentina&appid=e0812e75f9ced8afb4c67cea2af16cd6&units=metric&lang=es');
    return this.http.get<any[]>('http://api.openweathermap.org/data/2.5/weather?q=Mendoza,%20argentina&appid=e0812e75f9ced8afb4c67cea2af16cd6&units=metric&lang=es');
  }
